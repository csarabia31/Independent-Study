...
header('Content-Type: text/html; charset=utf-8');
    ...
    curl_setopt_array($curl, array(
	    CURLOPT_URL => "https://api-football-v1.p.rapidapi.com/v2/fixtures/league/524?timezone=Europe%2FLondon",
    ...
    $fp = fopen('PLmatches.json', 'w');
    fwrite($fp, json_encode($response));
    fclose($fp);
      

    $json = file_get_contents('PLmatches.json');
