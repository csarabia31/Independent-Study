...
include 'db_connection.php';
    ...
    curl_setopt_array($curl, array(
	    CURLOPT_URL => "https://api-football-v1.p.rapidapi.com/v2/fixtures/league/775?timezone=Europe%2FLondon",
    ...
    $fp = fopen('LaLigamatches.json', 'w');
    fwrite($fp, json_encode($response));
    fclose($fp);
      

    $json = file_get_contents('LaLigamatches.json');
